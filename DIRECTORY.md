...
*Public commits per dyad, trailing 7d as of 2026-06-09T22:12:15+00:00. A recruitment/liveness signal — “is anyone home?” — **not** a productivity metric. A private or unreachable repo is labelled, **never** counted as 0.*
...
*11 dyads registered · 7 active in window · 896 commits (7 repos reachable). Generated by a scheduled job; the per-dyad files in `directory/` remain the source of truth.*
